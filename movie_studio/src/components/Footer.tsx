...
Powered by data from The Movie Database (TMDB), we bring you the latest trailers, top-rated films, and trending titles — all in one place.

Whether you're into blockbusters or hidden gems, streamtube helps you explore, search, and enjoy movie content like never before.
        </p>
      </div>
      <div>
        <h2 className="text-base uppercase font-bold text-white tracking-wide border-b border-b-gray-600 py-2 mb-5 relative">
